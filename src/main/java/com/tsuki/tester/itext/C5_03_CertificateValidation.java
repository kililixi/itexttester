...
public class C5_03_CertificateValidation {
    ...
    public static final String ROOT = "/Users/startsi/Documents/csr/pdf/rootca.cer";

    public static final String EXAMPLE = "hello_server.pdf";
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        try (FileInputStream stream = new FileInputStream(ROOT)) {
            ks.setCertificateEntry("rootca", cf.generateCertificate(stream));
        }

        app.setKeyStore(ks);

        app.verifySignatures(DEST + EXAMPLE);
