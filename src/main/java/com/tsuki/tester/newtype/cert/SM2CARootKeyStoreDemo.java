...
public class SM2CARootKeyStoreDemo {
    ...
    private static X500Name dn() {
        ...
        // 组织
        builder.addRDN(BCStyle.O, "实邑科技");
        // 省份
        builder.addRDN(BCStyle.ST, "福建省");
        // 地区
        builder.addRDN(BCStyle.L, "福州市");
        // 通用名称
        builder.addRDN(BCStyle.CN, "实邑科技");
    ...
    public static void main(String[] args) throws Exception {
        ...
        File file = new File("/Users/startsi/Documents/csr/newesign/ROOT.p12");
        if (file.exists()) {
            file.delete();
        }
        // 1. 产生密钥对
